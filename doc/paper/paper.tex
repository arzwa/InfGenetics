...
inbreeding in tetraploids canceled by the reduction in genetic variance 
(\cref{fig:est1}B,C).
...
\caption{
    ...
    The line for the $\theta=3$ case lies around 0.25 and is not shown.
...
probability of tetraploid establishment in some cases.
...
differ systematically across ploidy levels \citep{porturas2019}.
