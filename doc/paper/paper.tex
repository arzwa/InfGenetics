...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\linewidth]{/home/arzwa/dev/InfGenetics/doc/paper/figs/estwmig.pdf}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=0.9\linewidth]{/home/arzwa/dev/InfGenetics/doc/paper/figs/prez.pdf} 
    \caption{
...
The meta-analysis performed by \cite{porturas2019} suggests that phenotypic
variation across ploidy levels is indeed fairly constant, so this assumption
...
(in particular \cite{griswold2021}, who made an assumption equivalent to
$\beta_4 = 1/2$ in our model), and such assumptions evidently impact the
establishment probability (\cref{fig:est1}).
Clearly, it would be very interesting to experimentally assess whether
typical quantitative traits in mixed-ploidy populations follow approximately
the mixed-ploidy infinitesimal model we outlined in this paper, and to actually
