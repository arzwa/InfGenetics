...
%DIF ADD paper.tex         Thu Apr  3 13:48:30 2025
    \input{preamble.tex}
...
Differences across cytotypes in how the genetic variance evolves over time as a
consequence of inbreeding will then further cause rates of adaptation to
differ, leading to different establishment probabilities even when
$\beta_4^2=1/2$.
}
...
inbreeding in tetraploids canceled \DIFaddbegin \DIFadd{by the reduction in genetic variance 
}\DIFaddend (\cref{fig:est1}B,C).
...
\DIFaddendFL \caption{
    ...
    The \DIFaddbeginFL \DIFaddFL{line for the $\theta=3$ case lies around 0.25 and is not shown.
    The }\DIFaddendFL dashed horizontal line marks the proportion of tetraploid migrants
