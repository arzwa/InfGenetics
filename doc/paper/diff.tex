...
%DIF ADD paper.tex         Wed Apr 16 13:55:43 2025
    \input{preamble.tex}
...
\begin{document}
    ...
    %DIF < \author[1]{Arthur Zwaenepoel\thanks{arthur.zwaenepoel@uantwerpen.be}}
%DIF < \affil[1]{\footnotesize Department of Biology, University of Antwerp, 2020 Antwerp, Belgium}
\DIFdelbegin %DIFDELCMD < \author{%%%
\DIFdelend \DIFaddbegin \author[1]{\DIFadd{Arthur Zwaenepoel}\thanks{arthur.zwaenepoel@uantwerpen.be}\DIFaddend }
    \DIFaddbegin \affil[1]{\footnotesize Department of Biology, University of Antwerp, 2020 Antwerp, Belgium}
    %DIF > \author{}
    \DIFaddend \date{\vspace{-5ex}}
    \maketitle
    \begin{abstract}
...
\DIFdelend \DIFaddbegin \DIFadd{from a Gaussian distribution with mean $\overline{z_{ij}^{kl}} + \gamma
    ...
    %DIF > Documented code and simulation notebooks are available at \url{[anonymized]}.
    Documented code and simulation notebooks are available at
    \DIFdelbegin %DIFDELCMD < \url{[anonymized]}%%%
...
\begin{figure}[t]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.8\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/tetfininf.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/fig1.pdf}
\DIFaddendFL \caption{
...
\begin{figure}[t]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/est1b.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/fig2.pdf}
\DIFaddendFL \caption{
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/fig3.pdf}
\DIFaddendFL \caption{
...
\begin{figure}[t]
\centering
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/estwmigration1d.pdf}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/fig4.pdf}
\DIFaddendFL \caption{
...
\DIFdelbegin \DIFdel{Furthermore, we find that for small migration rates, the probability that
...
This suggests that maladaptive gene flow in diploids can increase }\DIFdelend \DIFaddbegin \DIFadd{However, }\DIFaddend the probability of tetraploid establishment \DIFdelbegin \DIFdel{.
However, at the same time we find that the tetraploid establishment probability
declines monotonically
with $m$, which highlights }\DIFdelend \DIFaddbegin \DIFadd{does decline monotonically
...
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.9\linewidth]{/home/arzwa/dev/InfGenetics/doc/img/fig5.pdf} 
    \DIFaddendFL \caption{
...
%DIF < 
%DIF < I thank Christelle Fraïsse for encouragement and feedback. Thanks to Quinten
%DIF < Bafort, Felipe Kauai and Frederik Mortier for comments on an early draft
%DIF < version.
%DIF < I acknowledge funding from the Research Foundation -- Flanders (FWO, Junior
%DIF < Postdoctoral Fellowship 1272625N).
\DIFaddbegin \DIFadd{While in this study we focused on polyploid establishment in a peripheral
...
\DIFadd{I acknowledge funding from the Research Foundation -- Flanders (FWO, Junior
Postdoctoral Fellowship 1272625N).
}

\section*{\DIFadd{Conflict of interest}}

\DIFadd{I have no conflict of interest to declare.
}

\section*{\DIFadd{Acknowledgements}}

\DIFadd{I thank two anonymous reviewers and the associate editor for their constructive
